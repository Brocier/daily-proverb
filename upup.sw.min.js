// ! UpUp Service Worker ! version : 1.0.0 ! author  : Tal Ater @TalAter !
// license : MIT ! https://github.com/TalAter/UpUp
...
self.addEventListener("fetch", function (e) {
  e.respondWith(fetch(e.request).catch(function () {
    return caches
      .match(e.request)
      .then(function (t) {
        return t || ("navigate" === e.request.mode || "GET" === e.request.method && e.request.headers.get("accept").includes("text/html")
...
var _parseSettingsAndCache = function (e) {
    var t = _CACHE_NAME_PREFIX + "-" + (e["cache-version"]
      ? e["cache-version"] + "-"
    ...
    return caches
      ...
      .then(function (t) {
        ...
        e["content-url"]
          ? fetch(e["content-url"], {mode: "no-cors"})
            .then(function (e) {
...
//# sourceMappingURL=upup.sw.min.js.map # sourceMappingURL=upup.sw.min.js.map